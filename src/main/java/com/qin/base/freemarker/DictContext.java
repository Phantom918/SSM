package com.qin.base.freemarker;
...
public class DictContext {
	...
	private DictContext() {
		...
		dictList.add(new String[] {"1", "男"});
		dictList.add(new String[] {"2", "女"});
		map.put("xb01", dictList); // 性别
		
		dictList = new ArrayList<String[]>();
		dictList.add(new String[] {"1", "专科"});
		dictList.add(new String[] {"2", "本科"});
		dictList.add(new String[] {"3", "硕士"});
		dictList.add(new String[] {"4", "博士"});
		dictList.add(new String[] {"5", "博士后"});
